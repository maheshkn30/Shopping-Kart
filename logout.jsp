<%-- 
    Document   : logout
    Created on : 21 Aug, 2022, 8:29:25 AM
    Author     : PC
--%>
...
<link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@700&display=swap" rel="stylesheet">
    ...
    <body>
        ...
        <section id="img">
         <a href=""><img src="pics/iconn.png" width="125" class="logo"></a>
         <div class="innerdiv">
    ...
    style="width:35px;height:35px">
        ...
        <input type="submit" onclick="fun()" title="LOGIN" value="enter" ><br>
