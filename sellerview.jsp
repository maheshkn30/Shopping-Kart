...
tr:nth-child(even){
 ...
 <th>EMAIL </th>
          ...
          <%
            rst=stmt.executeQuery("select * from slsign");
            while(rst.next())
            {
       out.println("<tr><td>"+ rst.getString("name")+ 
                   "</td><td>"+ rst.getString("password")+
                   "</td><td>"+ rst.getString("phone")+"</td><td>"+rst.getString("email") +"</td></tr>");
