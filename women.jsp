<%-- 
    Document   : women
    Created on : 9 Aug, 2022, 8:32:20 PM
    Author     : PC
--%>
...
/*flex-direction*/
    ...
    >
       ...
       <section id="heroo">
           <h1 class="women">SHOP BY</h1> <h1 class="womenn">WOMEN</h1>
     ...
     colors="primary:white">
      ...
      <div class="gallery"> 
             ...
             <%
                  ...
                  rs = st.executeQuery("select * from product where gen='women'");
                    while (rs.next()) {%>
                           
          <div class="img-container">                          
      <img src="view4.jsp?name=<%=rs.getString("name")%>" width="100" height="100"/>
      <div class="desc" style="font-size: 26px; color: #000;;"><%=rs.getString("price")%></div> 
