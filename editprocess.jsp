...
<link href="https://fonts.googleapis.com/css2?family=Ubuntu&display=swap" rel="stylesheet">
    ...
    <body>
        ...
        %>
         ...
         <div class="outerdiv">
         <div class="innerdiv">
            <form method="post" action="editcom.jsp">
        <h2>EDIT YOUR PROFILE</h2>
         <%
            ...
            while(rst.next())
            {
             ...
             %>   
         <input type="text" name="name" value="<%=rst.getString("name")%>" /><br><br>
       <input type="text" name="username" readonly="" value="<%=rst.getString("username")%>" ><br><br>
      <input type="password" name="password" value="<%=rst.getString("password")%>"/><br><br>
       <input type="email" name="email"value="<%=rst.getString("email")%>"/><br><br>
      <input type="text" name="phone"  value="<%=rst.getString("phone")%>"  /><br><br>
                     <%
               }
